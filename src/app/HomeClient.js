...
useEffect(()=>{if(sessionStorage.getItem('fromGame')){setShowHomeOverlay(true);sessionStorage.removeItem('fromGame');const t=setTimeout(()=>setShowHomeOverlay(false),100);return()=>clearTimeout(t);}},[]);
